...
class Html
{
    ...
    public function toRichTextObject($html)
    {
        ...
        //@$dom->loadHTML('<?xml encoding="UTF-8">' .'html h很好<strong><strike>pizza</strike></strong>');
	...
	protected function Node12(DOMText $textNode)
    {
       return $textNode;
    }
