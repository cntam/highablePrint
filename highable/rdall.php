...
$spreadsheet->getActiveSheet()->setTitle("RDp1");
...
if ($pdall['pdp1']['maxnum'] >= 0) {

    for ($formnum = 0; $formnum < $pdall['pdp1']['maxnum']; $formnum++) {
        ...
        $spreadsheet->getActiveSheet()->setCellValue("F{$efnum}", $pdall['pdp1']["frlistcon"][$formnum][1]);


        $efnum = (12 + 18* $formnum);
        $spreadsheet->getActiveSheet()->setCellValue("E{$efnum}", "IHK NO.:");
        $spreadsheet->getActiveSheet()->mergeCells("F{$efnum}:G{$efnum}");
        $spreadsheet->getActiveSheet()->setCellValue("F{$efnum}", $pdall['pdp1']["frlistcon"][$formnum][2]);

        $efnum = (14 + 18* $formnum);
        $spreadsheet->getActiveSheet()->setCellValue("E{$efnum}", "SUPPLIER:");
        $spreadsheet->getActiveSheet()->mergeCells("F{$efnum}:G{$efnum}");
        $spreadsheet->getActiveSheet()->setCellValue("F{$efnum}", $pdall['pdp1']["frlistcon"][$formnum][3]);

        $efnum = (16 + 18* $formnum);
        $spreadsheet->getActiveSheet()->setCellValue("E{$efnum}", "SUPPLIER CODE:");
        $spreadsheet->getActiveSheet()->mergeCells("F{$efnum}:G{$efnum}");
        $spreadsheet->getActiveSheet()->setCellValue("F{$efnum}", $pdall['pdp1']["frlistcon"][$formnum][4]);

        $efnum = (18 + 18* $formnum);
        $spreadsheet->getActiveSheet()->setCellValue("E{$efnum}", "COMP.:");
        $spreadsheet->getActiveSheet()->mergeCells("F{$efnum}:G{$efnum}");
        $spreadsheet->getActiveSheet()->setCellValue("F{$efnum}", $pdall['pdp1']["frlistcon"][$formnum][5]);

        $efnum = (20 + 18* $formnum);
        $spreadsheet->getActiveSheet()->setCellValue("E{$efnum}", "WIDTH:");
        $spreadsheet->getActiveSheet()->mergeCells("F{$efnum}:G{$efnum}");
        $spreadsheet->getActiveSheet()->setCellValue("F{$efnum}", $pdall['pdp1']["frlistcon"][$formnum][6]);

        $efnum = (22 + 18* $formnum);
        $spreadsheet->getActiveSheet()->setCellValue("E{$efnum}", "WEIGHT:");
        $spreadsheet->getActiveSheet()->mergeCells("F{$efnum}:G{$efnum}");
        $spreadsheet->getActiveSheet()->setCellValue("F{$efnum}", $pdall['pdp1']["frlistcon"][$formnum][7]);
        ...
        $spreadsheet->getActiveSheet()->setCellValue("F{$efnum}", $pdall['pdp1']["frlistcon"][$formnum][8]);

        $efnum = (26 + 18* $formnum);

        $spreadsheet->getActiveSheet()->setCellValue("E{$efnum}", "PRICE:");
        $spreadsheet->getActiveSheet()->mergeCells("F{$efnum}:G{$efnum}");
        $spreadsheet->getActiveSheet()->setCellValue("F{$efnum}", $pdall['pdp1']["frlistcon"][$formnum][10]);
        ...
        $img = $pdall['pdp1']["frlistcon"][$formnum][9];
        if ($img == '') {
            $haveimg = false;  //没有图片
 ...
 * SO 模块
 */
$SOnum = ($pdall['pdp1']['maxnum'] > 0 ? ($pdall['pdp1']['maxnum']-1) : 0);
$titlenum = (28 + 18 * ($pdall['pdp1']['maxnum'] > 0 ? ($pdall['pdp1']['maxnum']-1) : 0));
...
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_date"]);

$fgnum = (31 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "CATEGORY:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_category"]);

$fgnum = (33 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "STYLE NO.:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_styleno"]);

$fgnum = (35 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "CLIENT:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_client"]);

$fgnum = (37 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "FABRIC:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_fabric"]);

$fgnum = (39 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "FABRIC INFO:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_fabricinfo"]);

$fgnum = (41 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "LINING:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_lining"]);

$fgnum = (43 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "LINING INFO:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_lininginfo"]);

$fgnum = (45 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "TRIM:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_trim"]);

$fgnum = (47 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "TRIM INFO:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_triminfo"]);

$fgnum = (49 + 18 * $SOnum );
$fgnum2 = (50 + 18 * $SOnum );
$spreadsheet->getActiveSheet()->setCellValue("E{$fgnum}", "REMARK:");
$spreadsheet->getActiveSheet()->mergeCells("F{$fgnum}:G{$fgnum2}");
$spreadsheet->getActiveSheet()->setCellValue("F{$fgnum}", $pdall['pdp1']["SO_remark"]);
...
if ($pdall['pdp1']["p2pagenum"] >= 0) {

    for ($formnum = 0; $formnum < $pdall['pdp1']["p2pagenum"]; $formnum++) {

        $worksheet1 = $spreadsheet->createSheet(); //新增sheet；
        $spreadsheet->setActiveSheetIndex($activesheet);  //設置當前活動表
        $activesheet++;
        $worksheet1->setTitle('RDp2 sheet'.($activesheet-1));
        ...
        $p2page = $pdall['pdp1']["p2page"][$formnum];   //被选中的数组 值

        $ihkno= $pdall['pdp1']["frlistcon"][$p2page][2];
        $supplier = $pdall['pdp1']["frlistcon"][$p2page][3];
        $com =  $pdall['pdp1']["frlistcon"][$p2page][5];
        $faw = $pdall['pdp1']["frlistcon"][$p2page][6];
        $remark = $pdall['pdp1']["frlistcon"][$p2page][8];
        $img = $pdall['pdp1']["frlistcon"][$p2page][9];
...
$worksheet1->setTitle('RDp3 sheet');
$spreadsheet->setActiveSheetIndex($activesheet);  //設置當前活動表
//$spreadsheet->getActiveSheet()->setTitle("sheet4");

$client =  $pdall["pdp3"]['client'] ;
$date =    $pdall["pdp3"]['date'] ;
$remark1 = $pdall["pdp3"]['remark1'][1] ;
$remark2 = $pdall["pdp3"]['remark2'][1] ;
$remark3 = $pdall["pdp3"]['remark3'][1] ;
$remark4 = $pdall["pdp3"]['remark4'][1] ;
$remark5 = $pdall["pdp3"]['remark5'][1] ;
$remark6 = $pdall["pdp3"]['remark6'][1] ;
$remark7 = $pdall["pdp3"]['remark7'][1] ;
$remark8 = $pdall["pdp3"]['remark8'][1] ;


$remark1no = $pdall["pdp3"]['remark1'][0] ;
$remark2no = $pdall["pdp3"]['remark2'][0] ;
$remark3no = $pdall["pdp3"]['remark3'][0] ;
$remark4no = $pdall["pdp3"]['remark4'][0] ;
$remark5no = $pdall["pdp3"]['remark5'][0] ;
$remark6no = $pdall["pdp3"]['remark6'][0] ;
$remark7no = $pdall["pdp3"]['remark7'][0] ;
$remark8no = $pdall["pdp3"]['remark8'][0] ;
